...
class TestController extends Controller
{
    public function index()
    {
        ...
        return view('/layoutsNav2/test',compact('stages','pourcentage_pfe','pourcentage_im','count_pfe','count_im','pourcentage_li',
                                                'pourcentage_ma','pourcentage_do','pourcentage_en','pourcentage_te','pourcentage_in',
                                                'count_li','count_ma','count_do','count_en','count_te','count_in','pourcentage_ts','count_ts'));
    }
}
