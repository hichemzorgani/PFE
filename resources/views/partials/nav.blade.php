...
<body>
    <nav class="navbar navbar-expand navbar-light bg-dark">
        <div class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
                <a href="{{ route ('affectations.index') }}" class="nav-link text-white">Gérer les départements</a>
            </li>
            <li class="nav-item">
            ...
            <li id="li" class="nav-item dropdown">
                <a class="btn btn-warning btn-lg nav-link dropdown-toggle text-white" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
